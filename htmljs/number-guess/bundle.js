...
var _Instructions = __webpack_require__(34);
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.getSymbol = function (symbol) {
            _this.setState({ symbol: symbol });
        };

        _this.state = { symbol: null };
        return _this;
    }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: 'https://bewakes.com' },
                        ' Home'
                    )
                ),
                _react2.default.createElement(_Block.BlocksContainer, { rows: 10, columns: 12, setSymbol: this.getSymbol }),
                _react2.default.createElement(_Instructions2.default, { symbol: this.state.symbol })
            );
        }
    }]);
...
exports.BlocksContainer = exports.Block = undefined;
...
var getSymbol = function getSymbol(index, seed) {
...
var Block = exports.Block = function Block(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'span',
            { className: 'block-symbol' },
            ' ',
            getSymbol(index, seed)
        )
    );
};

var BlockRow = function BlockRow(_ref2) {
    ...
    return _react2.default.createElement(
        ...
        Array.from(Array(columns)).map(function (e, ind) {
            return _react2.default.createElement(Block, { seed: seed, key: ind, index: index * columns + ind });
        })
    );
};

var BlocksContainer = exports.BlocksContainer = function (_React$Component) {
    _inherits(BlocksContainer, _React$Component);

    function BlocksContainer(props) {
        _classCallCheck(this, BlocksContainer);

        var _this = _possibleConstructorReturn(this, (BlocksContainer.__proto__ || Object.getPrototypeOf(BlocksContainer)).call(this, props));

        _this.componentDidMount = function () {
            var seed = parseInt(Math.random() * 10, 10);
            _this.setState({ seed: seed });
            _this.props.setSymbol(symbols[seed]);
        };
    ...
    _createClass(BlocksContainer, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                Array.from(Array(this.props.rows)).map(function (e, i) {
                    return _react2.default.createElement(BlockRow, {
                        seed: _this2.state.seed,
                        key: i,
                        columns: _this2.props.columns,
                        index: i,
                        totalRows: _this2.props.rows
                    });
                })
            );
        }
...
var Instructions = function (_Component) {
    ...
    function Instructions(props) {
        ...
        _this.getCurrentText = function () {
            if (_this.state.step < 3) {
                return _this.instructions[_this.state.step];
            }
    ...
    _createClass(Instructions, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.nextStep, className: 'instruction-button' },
                    this.getButtonText()
                )
            );
        }
